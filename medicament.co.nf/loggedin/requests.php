...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        <h2 class="header center red-text text-darken-2">Requests</h2>
        <div class="row center">
            <p class="light center col s12">Need supplies? Request <a href="requestform.php" class="red-text text-darken-2">here</a>.</p>
        </div>
    </div>
</div>
    ...
    <div class="section">
        <div class="row">
            <div class="col s10 offset-s1">
                <ul class="tabs">
                    <li class="tab col s4"><a href="#requests">Unanswered Requests</a></li>
                </ul>
            </div>
            <div class="container">
                <div id="requests" class="col s12">
                    <ul class="collection">
                      ...
                      <span class="title"><b>(Item Title)</b><br><i>Requested by (Organization Name)</i></span>
                                <p>
                                (Item Description)
                                </p>
                                <br>
